...
import { getProductDetails, updateProduct } from '../actions/productActions.js';
...
const AdminUpdateEdit = ({ match, history }) => {
  ...
  useEffect(() => {
    if (successUpdate) {
      ...
      history.push('/admin/producs');
    } else {
      console.log(typeof product.foodId);
      console.log(typeof productId);
      console.log('aaaaaa', product.name, product.foodId, productId);
  ...
  return (
    <>
      <Link className='my-3 text-decoration-none' to='/admin/products'>
